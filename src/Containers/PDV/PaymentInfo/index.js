    ...
    <>
      ...
      <div className={styles.actionSale}>
        <Row gutter={[6, 0]}>
          <Col span={12}>
            <div
              onClick={() => handlePaymentType({ creditCard: !paymentType.creditCard, cash: !paymentType.cash })}
          ...
          <Col span={12}>
            <div  onClick={() => handlePaymentType({ creditCard: !paymentType.creditCard, cash: !paymentType.cash })}
              className={ClassNames(styles.cardSaleType, {
      ...
      >
        ...
        <Form.Item
          ...
          name="paymentMethod"
          rules={[{
            required: paymentType.cash ? false : true,
            message: 'Este campo é obrigatório!',
          }]}
        >
          <Select placeholder="Selecione o tipo do cartão" disabled={paymentType.cash}>
        ...
        >
          <Select placeholder="Selecione o número de parcelas" disabled={paymentType.cash}>
